...
/**
 * Class ForRentSignalParameter
 */
final class ForRentSignalParameter implements GetParameterInterface
{
    /** @var boolean */
    private $offline;
    ...
    /**
     * ForRentSignalParameter constructor.
     *
    ...
    public function serialize(): array
    {
        ...
        if ($this->isOffline() !== null) {
           $data['offline'] = $this->isOffline() ? 'true' : 'false';
        }
