...
/**
 * Class RiskClassReductionSignalParameter
 */
final class RiskClassReductionSignalParameter implements GetParameterInterface
{
    ...
    /**
     * RiskClassReductionSignalParameter constructor.
     *
