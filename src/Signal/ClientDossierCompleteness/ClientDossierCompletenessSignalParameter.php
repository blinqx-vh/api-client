...
/**
 * Class ClientDossierCompletenessSignalParameter
 */
final class ClientDossierCompletenessSignalParameter implements GetParameterInterface
{
    ...
    /**
     * ClientDossierCompletenessSignalParameter constructor.
     *
