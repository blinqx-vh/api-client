...
/**
 * Class SavingsBasedMortgageRefinancingSignalParameter
 */
final class SavingsBasedMortgageRefinancingSignalParameter implements GetParameterInterface
{
    ...
    /**
     * SavingsBasedMortgageRefinancingSignalParameter constructor.
     *
